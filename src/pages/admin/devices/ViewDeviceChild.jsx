...
const ViewDeviceChild = () => {
  ...
  const handleDelete = async () => {
    if (window.confirm("Apakah Anda yakin ingin menghapus perangkat anak ini?")) {
      try {
        await apiClient.delete(`/device-children/${id}`);
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex space-x-2">
          ...
          <button
            onClick={() => navigate(`/admin/device-children/${id}/edit`)}
...
export default ViewDeviceChild;