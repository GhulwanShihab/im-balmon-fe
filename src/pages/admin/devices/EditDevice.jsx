...
const EditDevice = () => {
    ...
    try {
      ...
      if (photos.length > 0) {
        for (const file of photos) {
          ...
          await apiClient.post(`/devices/${id}/photos`, formData, {
  ...
  const handleDeleteExistingPhoto = async (photoId) => {
    ...
    try {
      await apiClient.delete(`/devices/${id}/photos/${photoId}`);
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Edit Perangkat</h1>
          <p className="text-gray-600">Perbarui informasi perangkat monitoring</p>
        </div>
      </div>
